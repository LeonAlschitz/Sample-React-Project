...
export const TableIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M3 9H21M9 3V21" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
)
...
export const NetmapIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <circle cx="7" cy="5" r="1.5" stroke="currentColor" strokeWidth="1.5" fill="none"/>
    <circle cx="17" cy="7" r="1.5" stroke="currentColor" strokeWidth="1.5" fill="none"/>
    <circle cx="19" cy="14" r="1.5" stroke="currentColor" strokeWidth="1.5" fill="none"/>
    <circle cx="6" cy="18" r="1.5" stroke="currentColor" strokeWidth="1.5" fill="none"/>
    <circle cx="16" cy="19.5" r="1.5" stroke="currentColor" strokeWidth="1.5" fill="none"/>
    <line x1="12" y1="12" x2="7" y2="5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
    <line x1="12" y1="12" x2="17" y2="7" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
    <line x1="12" y1="12" x2="19" y2="14" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
    <line x1="12" y1="12" x2="6" y2="18" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
    <line x1="12" y1="12" x2="16" y2="19.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
  </svg>
)
